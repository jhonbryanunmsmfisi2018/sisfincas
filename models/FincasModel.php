...
class FincasModel extends Query{
    ...
    public function registrar($codigo, $direccion, $latlong,$valor, $ubicacion, $id_categoria, $foto)
    {
        $sql = "INSERT INTO predios (codigo, nombre_predio,latlong,valor,departamento,id_categoria,foto) VALUES (?,?,?,?,?,?,?)";
        $array = array($codigo, $direccion, $latlong,$valor, $ubicacion, $id_categoria, $foto);
