...
$secretKey = '6Lfks3EnAAAAAPUEJUUB6vuYPKuPBCoy1IK-io6t';
								...
								<div class="border p-4 rounded">
									...
									<div class="form-body">
										<form class="row g-3" id="formulario" method="POST" autocomplete="off">
											...
											<div class="mb-3">
												<div class="g-recaptcha" data-sitekey="6Lfks3EnAAAAAJNRg-MX8mTEecoDSgdJYUonPnZ1">
												</div>
											</div>
